...
1) Who is SWORD Group							      3
2) Project Main Purpose							      4
3) Web Applications Frameworks					      5
4) Intro to Django Backend Framework 				      7
5) Definition of a DBMS			  				      9
6) Definition of a Class diagram						    11
7) Project Class diagram 							    12
8) Database Structure Explanation 					    13
9) Application Pages and Functionalities				    17
i. Home Page							    18
ii. Sign-up Pages							    19
iii. Sign-in Pages							    22
iv. Patient dashboard and its components              23
v. Doctor dashboard and its components               28

10) Security Restrictions						    32
11) Summary									    34
...
This project was done under collaboration and mentoring of SWORD Group, which is well known by its values and principles clearly state, the ethical commitment of SWORD Group and its responsibility in all its fields of activity to clients, partners, employees, shareholders and suppliers.

It has many offers regarding solutions, consulting and services is aimed at all key accounts and public institutions at international level. It is based on our resources’ highly developed business know-how in different fields.

1. The Sword software division fields unparalleled, comprehensive and configurable solutions in various fields.

2. As an integrator consultancy, Sword fields
a range of specialised solutions and services ensuring high added value.
...
Django comes with a templates that are called “pages” of an application. It lets you handle HTML content in a templates and handles the management of its content via Django's views.py file and a Python API. A page is an object with a URL, title and content.
...
Her it’s an update because as mentioned above, when the doctor’s first register, a schedule is created for 7 days of a week with a starting and ending time set to 00:00, so when the doctor edits his info we must update the database from 00:00 to the chosen timestamps.
